class timesBR{
  constructor(nome,nome2) // Método construtor, serve para criar um método nosso, pois em si a class já posssui um método vázio
  {
    this.["Primeiro time :"] = nome
    this.["Segundo time :"] = nome2
