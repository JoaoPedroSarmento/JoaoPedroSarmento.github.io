...
console.log(time.Chanpions); // Mostrando no console  o elemento da propriedade Chanpions
console.log(time2[0]); // Mostrando no console o elemento da posição 0
console.log(time["Time Barcelona"]); // Mostrando no console um  object criado dentro de um object
